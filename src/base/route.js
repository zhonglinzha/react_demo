...
export default [
	{
        ...
        import(/* webpackChunkName: 'login' */ '@page/login').then(login => cb(null, login.default)).catch(e => console.log(e));
			},
		},
		childRoutes: [
		// 	{
		...
		// 	},
          ...
          import(/* webpackChunkName: 'home' */ '@page/home').then(home => cb(null, home.default)).catch(e => console.log(e));
			...
			},
			{
				path: 'about',
				getComponent(location, cb) {
          import(/* webpackChunkName: 'about' */ '@page/about').then(about => cb(null, about)).catch(e => console.log(e));
				},
			},
		],
	},
